module.exports.config = {
    ...
    function linkanh() {
        ...
        if ("1" == a.body)
         ...
         var   h = "https://apikanna.hoangphihung.repl.co";
        else if ("10" == a.body)
         ...
         var   h = "https://wibu.ocvat2810.repl.co";
          ...
          var  h = "https://api-random-img.hoangphihung.repl.co/lo1i";
         else if ("17" == a.body)
          var  h = "https://apirem.hoangphihung.repl.co";
         else if ("18" == a.body)
          var  h = "https://api-4.hoangphihung.repl.co/naughty.php";
         else if ("19" == a.body)
          var  h = "https://apiviolet.hoangphihung.repl.co";
         return { p, h };
    }
};