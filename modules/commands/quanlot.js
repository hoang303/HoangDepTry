...
module.exports.run = async({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
    ...
    var callback = () => api.sendMessage({ body: `panties close : ${link.length}`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, (err, info) => setTimeout(() => api.unsendMessage(info.messageID), 15000), event.messageID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
