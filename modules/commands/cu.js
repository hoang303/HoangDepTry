...
"https://i.imgur.com/lmLouxB.jpg",
     ...
     var callback = () => api.sendMessage({body:`𝗕𝗼̂́ 𝗧𝗶𝗲̂𝗻 𝗦𝘂̛, 𝗖𝗼𝗻 𝗚𝗮́𝗶 𝗠𝗮̀ 𝗗𝗮̂𝗺 𝗖𝗵𝘂́𝗮 😤 đã báo cáo cho admin 
     https://www.facebook.com/User.Lucifer.s`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
