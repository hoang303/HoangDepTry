...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "45px time";
    //ctx.fillText("•" + "facebook.com/100076761695304", 240, 590)
    //ctx.fillText("•" + "instagram.com/Dongcr789/", 240, 670)
   // ctx.fillText("•" + "Trickerlomm", 405, 750)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
