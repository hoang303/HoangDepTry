...
var one = senderID, two = id;
    return makeImage({ one, two }).then(path => api.sendMessage({ body: `‎🎁 ️Chúc mừng ${namee} đã được ghép đôi với ${name} 🎉\n🎊 ️Tỉ Lệ Hợp Đôi là: 〘${tle}〙🥳`, mentions: arraytag, attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }