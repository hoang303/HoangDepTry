module.exports.config = {
    ...
    cooldowns: 0,
    dependencies: {
        "pastebin-api": "d60EJ9t_DiHnnVBAM0UilLL70LGyFcPm",
        "cheerio": "",
        "request": ""
    }
};
    ...
    if(!text && name) {
        var data = fs.readFile(
          ...
          async (err, data) => {
            ...
            const client = new PasteClient("d60EJ9t_DiHnnVBAM0UilLL70LGyFcPm");
        ...
        axios.get(url[0]).then(i => {
            ...
            fs.writeFile(
                ...
                function (err) {
                    ...
                    api.sendMessage(`.cmd l ${args[0]}`, threadID, messageID);
                }
            );
        })
    }
            ...
            load('.language-js').each((index, el) => {
                ...
                fs.writeFile(`${__dirname}/${args[0]}.js`, code, "utf-8",
                    function (err) {
                        ...
                        return api.sendMessage(`.cmd l "${args[0]}"`, threadID, messageID);
                    }
                );
            });
        });
